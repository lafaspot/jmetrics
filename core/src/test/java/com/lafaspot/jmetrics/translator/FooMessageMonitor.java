...
/**
 * Monitor FooMessage for test.
 *
 */
@MetricClass(enable = true, name = "FooMessageMonitor", applications = { "test", "dummy" })
public class FooMessageMonitor {
